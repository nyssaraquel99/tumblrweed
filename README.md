...
I wrote **tumblrweed** and **nuke** because I wanted to refresh my blog, but Tumblr doesn't natively have a way to easily delete all posts. Even the Mass Post Editor requires you to select each post to delete one by one. I had nearly 3000 posts on my 12 year old blog, so that simply wasn't going to happen. But I didn't want to give up my url or make a new blog. So over the course of four days, I riffled through Tumblr's API docs and put this script together to automate the process. Would it have been faster to suffer through Mass Post Editor and delete my posts manually? Probably. Could I have use the pytumblr client library instead of writing my own code? Sure. But now I have these scripts at hand in case of my next ego death. And, thanks to this repo, so do you!   
- - - - - - - - - - - -   
Notes:   
